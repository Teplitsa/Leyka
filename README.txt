...
* Поддерживаемые платёжные системы: Яндекс.деньги (протоколы ЕПР и p2p), Chronopay, RBK Money, ROBOKASSA, SMS-платежи (через стороннего провайдера), распечатка банковских квитанций, отображение статического текста.
