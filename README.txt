...
«Онлайн-Лейка» — это плагин для краудфандинга, фандрайзинга и сбора пожертвований на сайте для физических и юридических лиц. Поддерживаются платежи кредитными карточками Visa и MasterCard  через **Chronopay и RBK money**, так же подключаются **WebMoney, Яндекс.Деньги (YandexMoney)** и традиционные квитанции.
...
* Создавайте специальные страницы для различных благотворительных кампаний и проектов.
* Отслеживайте пожертвования с помощью извещений на эл. почту. и истории пожертвований.
...
* Редактируйте текст благодарственного письма донорам.
