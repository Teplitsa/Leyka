...
<div class="captioned-screen">
    <div class="screen-wrapper">
        <img src="<?php echo LEYKA_PLUGIN_BASE_URL?>img/cp/cp_copy_key.png" class="leyka-instructions-screen" />
        <img src="<?php echo LEYKA_PLUGIN_BASE_URL?>img/icon-zoom-screen.svg" class="zoom-screen" />
    </div>
    <img src="<?php echo LEYKA_PLUGIN_BASE_URL?>img/cp/cp_copy_key.png" class="leyka-instructions-screen-full" />
</div>
