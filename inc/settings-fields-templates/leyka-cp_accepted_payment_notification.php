...
<div class="captioned-screen">
    <p>Перевидите флажок у поля «Pay» в режим «Включено» и вставьте адрес  в поле, как на скриншоте:</p>
    <div class="screen-wrapper">
        <img src="<?php echo LEYKA_PLUGIN_BASE_URL?>img/cp/cp_accepted_payment_notification.png" class="leyka-instructions-screen" />
        <img src="<?php echo LEYKA_PLUGIN_BASE_URL?>img/icon-zoom-screen.svg" class="zoom-screen" />
    </div>
    <img src="<?php echo LEYKA_PLUGIN_BASE_URL?>img/cp/cp_accepted_payment_notification.png" class="leyka-instructions-screen-full" />
</div>
