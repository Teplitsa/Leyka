...
<div class="<?php echo esc_attr( $this->field_type ); ?> custom-block-captioned-screens">
    ...
    <span class="info2copy leyka-wizard-copy2clipboard"><?php echo esc_html( site_url('/leyka/service/cp/complete/'));?></span>
    ...
    <div class="captioned-screen">
        ...
        <div class="screen-wrapper">
            <img src="<?php echo esc_attr( LEYKA_PLUGIN_BASE_URL ); ?>img/cp/cp_accepted_payment_notification.png" class="leyka-instructions-screen" alt="">
            <img src="<?php echo esc_attr( LEYKA_PLUGIN_BASE_URL ); ?>img/icon-zoom-screen.svg" class="zoom-screen" alt="">
        </div>
        <img src="<?php echo esc_attr( LEYKA_PLUGIN_BASE_URL ); ?>img/cp/cp_accepted_payment_notification.png" class="leyka-instructions-screen-full" alt="">
