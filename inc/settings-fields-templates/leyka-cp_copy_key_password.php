...
<div class="captioned-screen">
    <div class="screen-wrapper">
        <img src="<?php echo esc_attr( LEYKA_PLUGIN_BASE_URL );?>img/cp/cp_copy_key.png" class="leyka-instructions-screen" alt="">
        <img src="<?php echo esc_attr( LEYKA_PLUGIN_BASE_URL );?>img/icon-zoom-screen.svg" class="zoom-screen" alt="">
    </div>
    <img src="<?php echo esc_attr( LEYKA_PLUGIN_BASE_URL );?>img/cp/cp_copy_key.png" class="leyka-instructions-screen-full" alt="">
</div>
