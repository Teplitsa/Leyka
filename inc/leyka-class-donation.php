    ...
    public static function add(array $params = array()) {
        ...
        if( !empty($params['donor_subscribed']) ) {
            add_post_meta($id, 'leyka_donor_subscribed', true);
				...
				if( !empty($params['recurrents_cancel_reason']) ) {
						add_post_meta($id, 'leyka_recurrents_cancel_reason', $params['recurrents_cancel_reason']);
				}
            ...
            $this->_donation_meta = array(
                ...
                'recurrents_cancel_date' => isset($meta['leyka_recurrents_cancel_date']) ?
                    $meta['leyka_recurrents_cancel_date'][0] : false,
								'recurrents_cancel_reason' => isset($meta['leyka_recurrents_cancel_reason']) ?
                    $meta['leyka_recurrents_cancel_reason'][0] : '',
            ...
            case 'recurring_cancel_date':
                return $this->payment_type === 'rebill' && !empty($this->_donation_meta['recurrents_cancel_date']) ?
                    $this->_donation_meta['recurrents_cancel_date'] : NULL;
						case 'recurrents_cancel_reason':
                return $this->payment_type === 'rebill' && !empty($this->_donation_meta['recurrents_cancel_reason']) ?
                    $this->_donation_meta['recurrents_cancel_reason'] : NULL;
        ...
        switch($field) {
            ...
            case 'recurring_is_active':
                ...
                break;
						...
						case 'recurrents_cancel_reason':
								$this->_donation_meta['recurrents_cancel_reason'] = trim($value);
								update_post_meta($this->_id, 'leyka_recurrents_cancel_reason', trim($value));
