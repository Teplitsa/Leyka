...
self::$_options_meta = array(
    'org_full_name' => array(
        ...
        'placeholder' => __('I. e., Eastern charity foundation', 'leyka'), // For text fields
    ...
    'org_face_fio_ip' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., John Frederic Dow', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'org_face_fio_rp' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., John Frederic Dow (in genitive case, if it exists)', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'org_face_position' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., Director', 'leyka'), // For text fields
    ...
    'org_address' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., Malrose str., 4, Washington, DC, USA', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    ...
    'org_bank_name' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., First Columbia Credit Bank', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ), 
    ...
    'donation_purpose_text' => array(
        ...
        'description' => '',
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., Charity donation', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    ...
    'currency_rur_label' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => 'I. e., «Roub.»', // For text fields
        'length' => 6, // For text fields
        'list_entries' => '', // callback returns currencies selected in prev. option
        'validation_rules' => array(), // List of regexp?..
    ),
    ...
    'currency_usd_label' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => 'I. e., «USD»', // For text fields
        'length' => 6, // For text fields
        'list_entries' => '', // callback returns currencies selected in prev. option
        'validation_rules' => array(), // List of regexp?..
    ),
    ...
    'currency_eur_label' => array(
        ...
        'required' => 1, // 1 if field is required, 0 otherwise
        'placeholder' => 'I. e., «euro»', // For text fields
        'length' => 6, // For text fields
        'list_entries' => '', // callback returns currencies selected in prev. option
        'validation_rules' => array(), // List of regexp?..
    ),
    ...
    'email_from_name' => array(
        ...
        'placeholder' => __('I. e., Daisy Foundation website', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'email_from' => array(
        ...
        'placeholder' => __('I. e., donations@daisyfoundation.org', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'email_thanks_title' => array(
        ...
        'required' => 1,
        'placeholder' => __('I. e., Daisy Foundation thanks you for your kindness', 'leyka'), // For text fields
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    ...
    'donations_managers_emails' => array(
        ...
        'description' => '',
        'required' => 0, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e., admin@daisyfoundation.org,yourmail@domain.com', 'leyka'),
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'email_notification_title' => array(
        ...
        'description' => '',
        'required' => 0, // 1 if field is required, 0 otherwise
        'placeholder' => __('I. e.., new donation incoming', 'leyka'),
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
...
//    ),
    ...
    'donation_submit_text' => array(
        ...
        'required' => 1,
        'placeholder' => __('I. e., «Donate» or «Support»', 'leyka'),
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'revo_donation_complete_button_text' => array(
        ...
        'required' => 1,
        'placeholder' => __('I. e., «Complete donation» or «Close form»', 'leyka'),
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'revo_thankyou_text' => array(
        ...
        'description' => '',
        'required' => 1,
        'placeholder' => __('I. e., «Thank you! We appreciate your help! Let\'s stay in touch.»', 'leyka'),
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
    'revo_thankyou_email_result_text' => array(
        ...
        'description' => '',
        'required' => 1,
        'placeholder' => __('I. e., «We will inform you about the result by email»', 'leyka'),
        'length' => '', // For text fields
        'list_entries' => array(), // For select, radio & checkbox fields
        'validation_rules' => array(), // List of regexp?..
    ),
