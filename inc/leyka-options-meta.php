...
//    ),
    ...
    'currency_rur_label' => array(
        ...
        'description' => sprintf(__('Please set the %s currency label here.', 'leyka'), __('RUB', 'leyka')),
        'required' => true,
        'placeholder' => sprintf(__('E.g., %s', 'leyka'), __('RUB', 'leyka')),
        'length' => 6,
    ),
    'currency_rur_min_sum' => array(
        'type' => 'number',
        'default' => 100,
        'title' => sprintf(__('Minimum sum available for %s', 'leyka'), __('RUB', 'leyka')),
        'description' => sprintf(__('Please set minimum amount available for %s donations.', 'leyka'), __('RUB', 'leyka')),
        'required' => true,
        'placeholder' => '100',
        'length' => 6,
    ),
    'currency_rur_max_sum' => array(
        'type' => 'number',
        'default' => 30000,
        'title' => sprintf(__('Maximum sum available for %s', 'leyka'), __('RUB', 'leyka')),
        'description' => sprintf(__('Please set maximum amount available for %s donations.', 'leyka'), __('RUB', 'leyka')),
        'required' => true,
        'placeholder' => '30000',
        'length' => 6,
    ),
    'currency_rur_flexible_default_amount' => array(
        'type' => 'number',
        'default' => 500,
        'title' => sprintf(__('Default amount of donation in %s (for "flexible" donation type)', 'leyka'), __('RUB', 'leyka')),
        'description' => sprintf(__('Please, set a default amount of donation when %s selected as currency.', 'leyka'), __('RUB', 'leyka')),
        'required' => true,
        'placeholder' => '500',
        'length' => 6,
    ),
    'currency_rur_fixed_amounts' => array(
        ...
        'title' => sprintf(__('Possible %s donation amounts (for "fixed" donation type)', 'leyka'), __('RUB', 'leyka')),
        'description' => sprintf(__('Please, set possible donation amounts in %s when "fixed" donation type is selected. Only an integer non-negative values, separated with commas.', 'leyka'), __('RUB', 'leyka')),
        'required' => true,
