    ...
    <div class="main-area all-extensions-settings all-addons-settings">
        ...
        <div class="extensions-cards-list">
            ...
            <?php foreach($addons as $addon_id => $addon) { /** @var $addon Leyka_Addon */
                ...
                <div class="extension-card addon-card <?php echo implode(' ', $addon->get_filter_categories());?>">

                    <div class="extension-card-header">

                        <div class="extension-card-icon"><?php leyka_show_addon_logo($addon, true);?></div>

                        <div>
                            <div class="extension-card-title">
                                <a class="extension-settings-link" href="<?php echo admin_url('admin.php?page=leyka_addons&addon='.$addon->id);?>">
                                    <?php echo $addon->title;?>
                                </a>
                            </div>
                            <div class="extension-card-status <?php echo $activation_status;?>">
                    ...
                    <div class="extension-card-params addon-description"><?php echo $addon->description;?></div>
