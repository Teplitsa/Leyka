...
function leyka_mobi_money_plugins_loaded(){
    ...
    if( !defined('LEYKA_VERSION') ) {
        ...
        echo __('<div id="message" class="error"><strong>Error:</strong> base donations plugin is missing or inactive. It is required for MOBI.Money gateway module to work. MOBI.Money plugin will be deactivated.</div>', 'leyka-mobi-money');
    }
}
    ...
    function leyka_mobi_money_options($options){
        array_push(
            ...
            array(
                ...
                'name' => '<h4>'.__('MOBI.Money Settings', 'leyka-mobi-money').'</h4>',
                'type' => 'header',
                'desc' => '',
            ),
            array(
            ...
            array(
                ...
                'type' => 'rich_editor',
                'options' => array('default' => '<strong>MOBI.Деньги</strong> — современная система электронных платежей, которая позволяет:
<ul>
