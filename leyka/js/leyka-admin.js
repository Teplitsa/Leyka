...
//    $('body').on('click.leyka_status_switch', '.leyka_status_switch', function(e){
//        var $this = $(this),
//            $switcher = $this.find('.payment_status_switcher');
//        $this.append(' <img src="'+l10n.ajax_loader+'" />');
//        $.post(ajaxurl, {
//            'payment_id': $switcher.data('payment-id'),
//            'new_status': $switcher.data('new-status'),
//            'action': 'leyka-toggle-payment-status',
//            'leyka_nonce': $switcher.data('nonce')
//        }, function(resp){
//            resp = $.parseJSON(resp);
//            if(resp.status == 'ok') {
//                window.location.href = '';
