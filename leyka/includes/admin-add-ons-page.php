...
/**
 * @package Leyka
 * @subpackage Add ons page modifications
 ...
 * @return void
 */
function leyka_add_ons_page() {
    ob_start(); ?>
    <div class="wrap" id="edd-add-ons">
        <h2>
            <?php _e('Add ons for Leyka', 'leyka');?>
        ...
        <p><?php _e('These add-ons extend and customize the functionality of Leyka.', 'leyka');?></p>
        <?php echo leyka_add_ons_get_feed(); ?>
    </div>
    <?php
    echo ob_get_clean();
}
 ...
 * @return void
 */
function leyka_add_ons_get_feed() {
    if(($cache = get_transient('easydigitaldownloads_add_ons_feed')) === false) {
        /** @todo Change feed URL to the leyka.te-st.ru based one */
