...
function leyka_admin_init(){
    ...
    function leyka_donate_meta_boxes(){
        ...
        add_meta_box('downloadinformation', __('Donate configuration', 'leyka'), 'edd_render_download_meta_box', 'download', 'high', 'default');
...
//    add_action('edd_logs_view_sales', 'leyka_logs_view_donations');
    ...
    function leyka_emails_settings($settings){
        ...
        $settings['purchase_receipt']['options']['default'] = __('Hello, {name}!<br /><br />
                                                 ...
                                                 Sincerely thank you,
                                                 {sitename}, {date}', 'leyka');
        $settings['purchase_receipt']['name'] = __("Donations manager's emails", 'leyka');
...
function leyka_admin_purchase_notification($admin_message, $payment_id, $payment_data){
    ...
    $admin_message = str_replace(
        ...
        array($payment_id, '<a href="'.site_url("/wp-admin/edit.php?post_type=download&page=edd-payment-history").'">'.__('Activate the donation', 'leyka').'</a>'),
