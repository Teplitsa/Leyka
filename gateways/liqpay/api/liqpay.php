...
class LiqPay {
    ...
    public function cnb_form($params) {
        ...
        return sprintf('
            ...
            ',
            $this->_checkout_url,
            sprintf('<input type="hidden" name="%s" value="%s" />', 'data', $this->encode_params($params)),
            sprintf('<input type="hidden" name="%s" value="%s" />', 'signature', $this->cnb_signature($params)),
            $language
        );
    ...
    public function cnb_signature($params) {
        ...
        $private_key = $this->_private_key;
        $json = $this->encode_params($this->cnb_params($params));
