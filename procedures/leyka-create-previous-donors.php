...
$donations = Leyka_Donations::get_instance()->get(array( // Get Donations w/o Donor assigned
...
//        $donor_metadata_params = array('process_only_funded_donations' => $procedure_options['process_only_funded']);
...
//    $donor_donations_ids = array();
//    $donor_donations_ids = Leyka_Donations::get_instance()->get(array(
